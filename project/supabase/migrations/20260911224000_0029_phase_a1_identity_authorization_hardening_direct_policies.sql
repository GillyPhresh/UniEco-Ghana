...
-- The clean staging baseline contains no policies that trust custom JWT role claims.
-- The explicit A1 policies below replace the known baseline policy names directly;
-- no policy-definition introspection is required or permitted in this successor.
